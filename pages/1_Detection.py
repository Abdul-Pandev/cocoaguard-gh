...
with st.sidebar:
    ...
    st.markdown('<div style="text-align:center;font-size:0.68rem;color:#4A7A52;letter-spacing:1.5px;text-transform:uppercase;margin-bottom:16px;">Sankofa Intelligence</div>', unsafe_allow_html=True)
