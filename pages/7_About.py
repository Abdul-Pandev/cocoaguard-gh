...
<div class="feature-card" style="margin-bottom:16px;">
  ...
  <p style="color:#C8DFC9;font-size:0.98rem;line-height:1.85;margin:16px 0 0;">CSSVD does not discriminate. Neither should early detection.</p>
</div>
""", unsafe_allow_html=True)
...
with c1:
    ...
    <div class="feature-card">
      <p style="color:#C8DFC9;font-size:0.92rem;line-height:1.85;font-style:italic;">"Se wo were fi na wosankofa a yenkyi"</p>
      <p style="color:#7AAB80;font-size:0.82rem;margin-top:-8px;">(Twi) — "It is not wrong to go back for what you forgot."</p>
...
stack = [
    [("🧠 TensorFlow","Deep learning model training & inference"),("⚡ EfficientNetB3","Pretrained CNN backbone (ImageNet)"),("🔁 JAX","Additional ML computation support")],
...
st.markdown("""
<div style="background:rgba(201,168,76,0.06);border:1px solid rgba(201,168,76,0.2);border-left:4px solid #C9A84C;
            border-radius:12px;padding:20px 24px;color:#C8DFC9;font-size:0.88rem;line-height:1.8;">
