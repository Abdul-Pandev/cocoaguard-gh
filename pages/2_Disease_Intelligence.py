...
<div class="feature-card" style="margin-bottom:16px;">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:20px;">
    <div><div style="color:#C9A84C;font-weight:700;font-family:'Syne',sans-serif;margin-bottom:8px;">① Mealybug Feeding</div><div style="color:#C8DFC9;font-size:0.85rem;line-height:1.7;">Mealybugs acquire the virus by feeding on infected trees for as little as 15 minutes.</div></div>
    <div><div style="color:#C9A84C;font-weight:700;font-family:'Syne',sans-serif;margin-bottom:8px;">② Movement</div><div style="color:#C8DFC9;font-size:0.85rem;line-height:1.7;">Mealybugs walk between adjacent trees or are carried by ants, wind, and human activity.</div></div>
    <div><div style="color:#C9A84C;font-weight:700;font-family:'Syne',sans-serif;margin-bottom:8px;">③ Inoculation</div><div style="color:#C8DFC9;font-size:0.85rem;line-height:1.7;">A single viruliferous mealybug can infect a healthy tree within minutes of feeding.</div></div>
    <div><div style="color:#C9A84C;font-weight:700;font-family:'Syne',sans-serif;margin-bottom:8px;">④ Incubation</div><div style="color:#C8DFC9;font-size:0.85rem;line-height:1.7;">Symptoms appear 3–6 months after infection. Nearby trees may already be infected by then.</div></div>
  </div>
</div>
""", unsafe_allow_html=True)
...
with m1:
    ...
    <div class="feature-card">
      ...
      <div style="margin-top:10px;">
        <div style="display:flex;gap:8px;margin-bottom:9px;font-size:0.85rem;"><span style="color:#3DCC52;font-weight:700;">1.</span><span style="color:#C8DFC9;"><b>Regular monitoring</b> — Inspect farms every 2–4 weeks.</span></div>
        ...
        <div style="display:flex;gap:8px;margin-bottom:9px;font-size:0.85rem;"><span style="color:#3DCC52;font-weight:700;">3.</span><span style="color:#C8DFC9;"><b>Controlled roguing</b> — Remove infected trees under COCOBOD supervision.</span></div>
        ...
        <div style="display:flex;gap:8px;font-size:0.85rem;"><span style="color:#3DCC52;font-weight:700;">5.</span><span style="color:#C8DFC9;"><b>Replant</b> — Use CRIG-approved hybrid seedlings.</span></div>
      </div>
    </div>
    """, unsafe_allow_html=True)
with m2:
    ...
    <div class="feature-card" style="background:linear-gradient(135deg,rgba(201,168,76,0.06),rgba(15,34,18,0.8));">
      ...
      <div style="margin-top:10px;display:flex;flex-direction:column;gap:12px;">
        ...
        <div style="background:rgba(61,204,82,0.07);border:1px solid rgba(61,204,82,0.2);border-radius:8px;padding:12px;">
          ...
          <div style="color:#7AAB80;font-size:0.8rem;margin-top:2px;">Cocoa Research Institute of Ghana</div>
        </div>
        <div style="background:rgba(61,204,82,0.07);border:1px solid rgba(61,204,82,0.2);border-radius:8px;padding:12px;">
